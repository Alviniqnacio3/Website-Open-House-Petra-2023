...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../2023/asset/favicon.png">
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="limiter">
        <div class="overlay" style="width: 250px;">
            <img src="../2023/asset/logo_pcuwggoh.png" class="img-fluid">
        </div>
        <div class="container-login100">
            <div class="wrap-login100">

                <form class="login100-form validate-form" method="post" action="api/ceklogin.php">
